...
<div class="container"><div class="row"><div class="col-lg-8"><div class="hero-text">
                        ...
                        <a href="#BMIcalculator" class="primary-btn">Read More</a>
</div></div></div></div></section>
     <!--Hero Section End--> 

     <!--BMI Section Begin--> 
    <span id="BMIcalculator"></span><section class="about-section spad"><div class="container"><div class="row"><div class="col-lg-6">
                  <iframe src="https://www.calculator.net/bmi-calculator.html"
                   width="600" height="400" frameborder="0" style="border:0;overflow:hidden;margin-left:-15px;position:relative;"
                   scrolling="no" allowfullscreen="" aria-hidden="false" tabindex="0">
                  </iframe>
</div><div class="col-lg-6"><div class="about-text">
                        <h2>BMI Calculator</h2>
                        <p class="first-para">BMI is a measurement of a person's leanness or corpulence based on their height and weight,
                          and is intended to quantify tissue mass. It is widely used as a general indicator of whether a person has a healthy body weight for their height.</p>
                        <p class="second-para">Specifically, the value obtained from the calculation of BMI is used to categorize whether a person is underweight,
                          normal weight, overweight, or obese depending on what range the value falls between.</p>
...
<section class="about-section spad"><div class="container"><div class="row"><div class="col-lg-6"><div class="about-pic">
                        ...
                        <p class="first-para">Lorem ipsum nibh pregnant microwave or outdoor author of bananas.
                           Aeneas price of care, but is hated by a lot of snow will auci mus ipsutissem consequat elitr running from the mainstream.</p>
                        <p class="second-para">Even Zen. Maecenas time Class sauce tomato sauce, which is always free pregnant carrots.
                           Even Zen. Maecenas time Class sauce tomato sauce, which is always free pregnant carrots.</p>
...
</div></div><div class="single-class-item set-bg" data-setbg="img/classes/classes-6.jpg"><div class="si-text">
                                                <h4>Weight Loss</h4>
                            <span><i class="fa fa-user"></i> Ryan Scott</span>
</div></div></div><div class="col-lg-4"><div class="single-class-item set-bg" data-setbg="img/classes/classes-7.jpg"><div class="si-text">
                                <h4>Personal Training</h4>
                            <span><i class="fa fa-user"></i> Cole Robertson</span>
</div></div><div class="single-class-item set-bg" data-setbg="img/classes/classes-8.jpg"><div class="si-text">
                                <h4>Weight Loss</h4>
                            <span><i class="fa fa-user"></i> Ryan Scott</span>
...
<div class="trainer-social">
                                ...
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-pinterest"></i></a>
</div></div></div></div></div></div></section></span>
<section class="testimonial-section spad"><div class="container"><div class="row"><div class="col-lg-12"><div class="section-title">
...
<div class="container"><div class="row"><div class="col-lg-6"><div class="banner-text">
...
<div class="container"><div class="row"><div class="col-lg-12"><div class="section-title">
                        <h2>MEMBERSHIP PLANS</h2>
</div></div></div><div class="row"><div class="col-lg-4"><div class="membership-item"><div class="mi-title">
                            <h4>Basic</h4>
<div class="triangle"></div></div>
                  ...
                  <a href="Payment" class="primary-btn membership-btn">Start Now</a>
</div></div><div class="col-lg-4"><div class="membership-item"><div class="mi-title">
                                    <h4>Standard</h4>
<div class="triangle"></div></div>
...
<div class="triangle"></div></div>
    ...
    <section class="footer-banner"><div class="container-fluid"><div class="row"><div class="col-lg-6"><div class="footer-banner-item set-bg" data-setbg="img/footer-banner/footer-banner-1.jpg">
...
</div></div><div class="col-lg-6"><div class="footer-banner-item set-bg" data-setbg="img/footer-banner/footer-banner-2.jpg">
