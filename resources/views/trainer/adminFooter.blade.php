 ...
 <div class="col-md-4">
  ...
  <span>Address</span>
        ...
        <div class="copyright-text">
            <p>
              <p>
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This is made with <i class="fa fa-heart" aria-hidden="true"></i> by SWTeam
              </p>
            </p>
        </div>
    </div>
...
<!-- Footer Section End -->
<button id="btnScrollToTop">  <i class="fa fa-chevron-up" style="font-size:24px"></i>
</button>
